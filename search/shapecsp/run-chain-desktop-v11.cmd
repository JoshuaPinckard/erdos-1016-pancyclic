@echo off
REM Sequential chain for the desktop GPU.  Successor to run-chain-desktop-v10.cmd
...
echo [chain] start %DATE% %TIME% script=v11 plan=pairwise runner=pairwise-prod
